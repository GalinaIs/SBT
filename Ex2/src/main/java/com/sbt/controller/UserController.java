...
public class UserController {
    ...
    @GetMapping
    public String userList(@AuthenticationPrincipal User userAuth, Model model) {
    ...
    @GetMapping("{user}")
    public String userEditForm(@AuthenticationPrincipal User userAuth, @PathVariable User user, Model model) {
        model.addAttribute("userAuth", userAuth);
